...
回测数据为:DCE.j2101和DCE.jm2101的1min数据
回测时间为:2020-08-01 08:00:00到2020-11-30 08:00:00
'''

def init(context):
    # 选择的两个合约
    context.symbol = ['DCE.j2101', 'DCE.jm2101']
    # 订阅历史数据
...
if __name__ == '__main__':
    ...
    run(strategy_id='strategy_id',
        ...
        mode=MODE_BACKTEST,
        token='{{token}}',
        backtest_start_time='2020-08-01 08:00:00',
        backtest_end_time='2020-11-30 16:00:00',
